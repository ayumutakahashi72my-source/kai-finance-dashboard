  ...
  return (
    <div ref={ref} className="relative shrink-0">
      ...
      {open && (
        ...
        >
          {/* プロフィール情報 */}
          <div className="px-4 py-3" style={{ borderBottom: `1px solid ${KAI.overlayBorder}` }}>
            <p className="truncate text-[13px] font-semibold" style={{ color: KAI.text1 }}>
              {displayName}
            </p>
          </div>
          ...
          <div className="p-1.5 space-y-0.5">
            ...
            {/* 区切り線 */}
            <div className="my-1 mx-1" style={{ borderTop: `1px solid ${KAI.overlayBorder}` }} />
