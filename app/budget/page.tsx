...
export default async function BudgetPage({
  ...
  const initialTab = Math.min(Math.max(Number(rawTab) || 0, 0), 2)
  ...
  return (
    <div className="min-h-screen" style={{ background: KAI.bg }}>
      <div aria-hidden className="mesh-bg pointer-events-none fixed inset-0" style={{ zIndex: 0, backgroundImage: `radial-gradient(ellipse 700px 500px at 80% 8%, rgba(167,139,250,.08), transparent 55%),radial-gradient(ellipse 500px 400px at 12% 78%, rgba(251,148,119,.06), transparent 55%)` }} />
      ...
      <div className="relative min-h-screen lg:pl-[220px]" style={{ zIndex: 2 }}>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:block">
              <h1 className="text-[17px] font-bold" style={{ color: KAI.text1 }}>予算</h1>
        ...
        <main className="mx-auto max-w-2xl space-y-3 px-4 py-5 pb-32 lg:pb-10">
          <BudgetPageTabs month={month} initialTab={initialTab} />
        </main>
      </div>
